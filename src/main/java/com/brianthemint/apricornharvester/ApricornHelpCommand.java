...
public class ApricornHelpCommand implements ICommand {
    ...
    public void execute(String label, IArgConsumer args) {
        ...
        switch (topic) {
            case "" -> overview();
            case "farm", "harvest" -> lines(HARVEST);
    ...
    private void overview() {
        ...
        logDirect("");
        logDirect("Topics: #ah workflow | farm | plant | bonemeal | pokeball | loc | keys");
    ...
    static final String[] WORKFLOW = {
            "Typical cycle:",
            "  1. #sel pos1 / #sel pos2 around the field, then #save myfarm",
            "  2. #loc harvest sel myfarm   (and #loc harvest cmd home farm)",
